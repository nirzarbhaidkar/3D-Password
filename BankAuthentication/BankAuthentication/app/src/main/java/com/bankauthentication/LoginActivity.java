...
public class LoginActivity extends AppCompatActivity {
    ...
    private static String url_create_product = "http://www.proitce.com/Authentication/app/checkLogin.php";
...
/*        if (controller.directLogin() > 0) {
            Intent i = new Intent(LoginActivity.this, ScanQRActivity.class);
            startActivity(i);
            finish();
        }
*/
    ...
    class CheckUser extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            Log.d("sameen",Username);
            Log.d("sameen",Password);
